# Generated by Powerlevel10k configuration wizard on 2021-06-26 at 14:07 -03.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 20612.
# Wizard options: compatible, classic, unicode, darkest, 24h time, blurred heads,
# blurred tails, 2 lines, dotted, full frame, sparse, fluent, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%002F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%215F⇡$P9K_IP_TX_RATE }%38F$P9K_IP_IP'
