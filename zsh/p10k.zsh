# Generated by Powerlevel10k configuration wizard on 2021-07-04 at 14:36 -03.
...
# flat tails, 2 lines, dotted, no frame, sparse, fluent, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#151515} %K{#101010} %k'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#101010} %K{#151515} %k'
  # The left end of left prompt.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#101010} %K{#151515} %k'
  # The right end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#151515} %K{#101010} %k'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%04F'   # blue foreground
      local conflicted='%01F'  # red foreground
    else
