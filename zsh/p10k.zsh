# Generated by Powerlevel10k configuration wizard on 2021-07-07 at 00:35 -03.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51222.
# Wizard options: compatible, unicode, lean_8colors, 24h time, 2 lines, disconnected,
# no frame, sparse, fluent, transient_prompt, instant_prompt=verbose.
